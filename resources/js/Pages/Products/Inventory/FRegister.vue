...
<template>
  <form class="fondo p-5 rounded-md grid grid-cols-2 gap-3" @submit.prevent="submit">
    <h3 class="title text-center col-span-full">Entrada</h3>
      ...
      <div class="relative">
        ...
        <div class="flex">
          ...
          <FontAwesomeIcon
            ...
            class="bg-cyan-400 ml-2 px-3 py-1.5 py-auto rounded-md icon-efect"
    ...
    <div>
      ...
      <Money class="inputGeneral w-full" v-bind="moneyConfig" v-model="form.quantity" />
      <InputError :message="form.errors?.quantity" />
    </div>
    <!-- Cantidad -->
    <div>
      <InputLabel for="cost" value="Costo x Unidad" />
      <Money class="inputGeneral w-full" v-bind="moneyConfig" v-model="form.cost" />
      <InputError :message="form.errors?.cost" />
    </div>

    <!-- Comentario -->
    <div class=" ">
      <InputLabel for="description" value="Comentario" />
      <TextInput class="w-full" placeholder="Artilculo recien llegado" v-model="form.description" />
  ...
  <FloatBox v-model:show="showProduct">
