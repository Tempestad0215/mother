...
<template>
  <div class="fondo mt-3 rounded-md p-5">
    <div class="flex justify-between items-center">
      ...
      <h3 class="text-3xl font-bold">Categorias</h3>
    </div>
    ...
    <table class="mt-3 styleTable table-fixed w-full">
      <thead>
        <tr>
          <th @dblclick="field('name')" class="w-[25rem]">
            <i v-if="form.field === 'name'" class="fa-solid fa-arrow-down mr-2"></i>
            Nombre
          </th>
          <th @dblclick="field('description')">
            <i v-if="form.field === 'description'" class="fa-solid fa-arrow-down mr-2"></i>
            Desripción
          </th>
      ...
      <tbody>
        <tr v-for="item in propsW.categories.data">
          ...
          <td>
            <i @click="edit(item)" title="Editar" class="icon-efect fa-solid fa-pen-to-square"></i>
            <i
              @click="destroy(item)"
              title="Eliminar"
    ...
    <Pagination
      ...
      :search="form.search"
      :next="propsW.categories.links.next"
      :total-page="propsW.categories.meta.to"
      :prev="propsW.categories.links.prev"
      :current-page="propsW.categories.meta.current_page"
