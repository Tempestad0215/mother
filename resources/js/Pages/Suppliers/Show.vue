...
<template>
  <AppLayout>
    <template #header>
      <TabLink :href="route('supplier.create')"> Registrar </TabLink>
      <TabLink :active="true" :href="route('supplier.show')"> Mostrar </TabLink>
    </template>

    <div>
      <FShow @seeSupplier="getDataSupplier" :suppliers="propsW.suppliers" />
    </div>
  </AppLayout>
